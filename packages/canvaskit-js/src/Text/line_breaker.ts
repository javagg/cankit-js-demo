 ...
 */
//https://github.com/flutter/engine/blob/main/third_party/web_unicode/lib/web_unicode/codegen/line_break_properties.dart
 ...
 */
export class FWLineBreakFragmenter extends TextFragmenter {
